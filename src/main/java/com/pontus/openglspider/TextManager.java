...
public class TextManager {
    ...
    public void removeText(TextObject obj) {
        // Add text object to our collection
        txtcollection.remove(obj);
    }
    public void removeAll() {
        // Add text object to our collection
        txtcollection.removeAllElements();
    }
    ...
    private int convertCharToIndex(int c_val) {
        ...
        if (c_val > 64 && c_val < 91) // A-Z
            ...
            indx = 45;
// here we are
        else if ((char)(c_val)  == '#') // # (X)
            indx = 48;
        else if ((char)(c_val)  == '(') // ( (xxx1)
            indx = 49;
        else if ((char)(c_val)  == '>') // > (xx1)
            indx = 51;
        else if ((char)(c_val)  == '%') // % (bug)
            indx = 56;
        else if ((char)(c_val)  == ')') // )  (xxx2)
            indx = 57;
        else if ((char)(c_val)  == '<') // < (xx2)
            indx = 59;
